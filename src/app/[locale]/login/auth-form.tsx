  ...
  return (
    <Card className="w-full bg-white/60 dark:bg-black/40 backdrop-blur-xl border-border/50 shadow-xl">
      ...
      <CardContent className="grid gap-4">
        <Button variant="outline" onClick={handleGoogleLogin} disabled={loading} className="w-full font-medium">
        ...
        <div className="relative">
          ...
          <div className="relative flex justify-center text-xs uppercase">
            <span className="bg-background px-2 text-muted-foreground rounded">
